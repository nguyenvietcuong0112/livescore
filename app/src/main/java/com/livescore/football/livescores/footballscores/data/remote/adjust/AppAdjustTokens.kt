...
object AppAdjustTokens {
    ...
    const val EVENT_BUY_YEARLY = "yearly_package_success_token"
    const val EVENT_BUY_REMOVE_ADS = "remove_ads_success_token"
    
    const val RETENTION_DAY_1 = "retention_day_1_token"
    const val RETENTION_DAY_3 = "retention_day_3_token"
    const val RETENTION_DAY_7 = "retention_day_7_token"
}
