...
import com.livescore.app.myapplication.livescore.data.remote.model.LineupPlayerWrapperDto
import com.livescore.app.myapplication.livescore.databinding.ItemLineupRowBinding
...
class LineupAdapter : RecyclerView.Adapter<LineupAdapter.LineupViewHolder>() {
    ...
    inner class LineupViewHolder(private val binding: ItemLineupRowBinding) :
        ...
        fun bind(homePlayer: com.livescore.app.myapplication.livescore.data.remote.model.LineupPlayerDto?, awayPlayer: com.livescore.app.myapplication.livescore.data.remote.model.LineupPlayerDto?) {
            if (homePlayer != null) {
